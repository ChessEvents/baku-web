( function () {
    ...
    angular.module( 'app.table' )
        .controller( 'TableCtrl', [ '$scope', '$filter', '$http', '$mdToast',
            '$cookies', '$rootScope', '$window', TableCtrl
        ] );

    function TableCtrl( $scope, $filter, $http, $mdToast, $cookies, $rootScope, $window ) {
        var init;
        ...
        //     } else {
        //         $scope.select( 1 );
        //         $scope.countryFilter = JSON.parse( $scope.selectedCountry )._id.country;
        ...
        $http.get( 'app/data/countries/count.json' ).then( function ( data ) {
